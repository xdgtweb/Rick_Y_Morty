...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./Estilos/Temporada 6.css"/>
    ...
    <body>
        ...
        <main>
            ...
            <div class="main2"><label>Temporada 6</label></div>
            
            <div class="main3">
                <div class="cajamain1">
                    <a href="IdiomasT6C1.html" >
                        <label>Capitulo 1</label>
                        <div class="previsualizacion1">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Solaricks</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain2">
                    
                    <a href="IdiomasT6C2.html" >
                        <label>Capitulo 2</label>
                        <div class="previsualizacion2">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Rick: una muerte bien vivida</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain3">
                    ...
                    <a href="PROVISIONAL.html" >
                        ...
                        <div class="tituloEpisodio">
                            <label>Mortificación de Rickmas</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain4">
                    ...
                    <a href="PROVISIONAL.html" >
                        ...
                        <div class="tituloEpisodio">
                            <label>Jackrick meta completo</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain5">
                ...
                <div class="cajamain6">
                    ...
                    <a href="PROVISIONAL.html" >
                        ...
                        <div class="tituloEpisodio">
                            <label>Ricktional Mortpoon's</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain7">
                ...
                <div class="cajamain8">
                    ...
                    <a href="PROVISIONAL.html" >
                        ...
                        <div class="tituloEpisodio">
                            <label>Rick en Mort del Rey Mortur</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain9">
    ...
    <div class="contacto">
        ...
        <?php
    $archivo = "./Contadores de visitas/ContadorTemporada6.txt";
