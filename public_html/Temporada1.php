...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./Estilos/Temporada 1.css"/>
    ...
    <body>
        ...
        <div class="navpadre">
        <nav>
            <a href="Temporada1.php"><div class="caja1"><div class="caja2"></div><label>Temporada 1</label></div></a>
            <a href="Temporada2.php"><div class="caja1"><div class="caja2"></div><label>Temporada 2</label></div></a>
            <a href="Temporada3.php"><div class="caja1"><div class="caja2"></div><label>Temporada 3</label></div></a>
            <a href="Temporada4.php"><div class="caja1"><div class="caja2"></div><label>Temporada 4</label></div></a>
            <a href="Temporada5.php"><div class="caja1"><div class="caja2"></div><label>Temporada 5</label></div></a>
            <a href="Temporada6.php"><div class="caja1"><div class="caja2"></div><label>Temporada 6</label></div></a>
        </nav>
        ...
        <main>
            ...
            <div class="main2"><label>Temporada 1</label></div>
            
            <div class="main3">
                <div class="cajamain1">
                    <a href="IdiomasT1C1.html" >
                        <label>Capitulo 1</label>
                        <div class="previsualizacion1">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Buscando las Semillas</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain2">
                    
                    <a href="IdiomasT1C2.html" >
                        <label>Capitulo 2</label>
                        <div class="previsualizacion2">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Invasión Canina</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain3">
                    
                    <a href="IdiomasT1C3.html" >
                        <label>Capitulo 3</label>
                        <div class="previsualizacion3">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Parque Anatómico</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain4">
                    
                    <a href="IdiomasT1C4.html" >
                        <label>Capitulo 4</label>
                        <div class="previsualizacion4">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>La Simulación Alienígena</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain5">
                    
                    <a href="IdiomasT1C5.html" >
                        <label>Capitulo 5</label>
                        <div class="previsualizacion5">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Meeseeks Destructores</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain6">
                    
                    <a href="IdiomasT1C6.html" >
                        <label>Capitulo 6</label>
                        <div class="previsualizacion6">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>La Poción de Rick</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain7">
                    
                    <a href="IdiomasT1C7.html" >
                        <label>Capitulo 7</label>
                        <div class="previsualizacion7">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Criando un Gazorpazorp</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain8">
                    
                    <a href="IdiomasT1C8.html" >
                        <label>Capitulo 8</label>
                        <div class="previsualizacion8">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Televisión Interdimensional</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain9">
                    
                    <a href="IdiomasT1C9.html" >
                        <label>Capitulo 9</label>
                        <div class="previsualizacion9">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Cosas Necesarias</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain10">
                    
                    <a href="IdiomasT1C10.html" >
                        <label>Capitulo 10</label>
                        <div class="previsualizacion10">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Encuentros Cercanos a los Rick</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain11">
                    
                    <a href="IdiomasT1C11.html" >
                        <label>Capitulo 11</label>
                        <div class="previsualizacion11">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Es Hora de la Fiesta</label>
                        </div>
                    </a>
                </div>
    ...
    <?php
    $archivo = "./Contadores de visitas/ContadorTemporada1.txt";
