...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./Estilos/Temporada 5.css"/>
    ...
    <body>
        ...
        <main>
            ...
            <div class="main2"><label>Temporada 5</label></div>
            
            <div class="main3">
                <div class="cajamain1">
                    <a href="IdiomasT5C1.html" >
                        <label>Capitulo 1</label>
                        <div class="previsualizacion1">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Mi Cena con André a la Morty</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain2">
                    
                    <a href="IdiomasT5C2.html" >
                        <label>Capitulo 2</label>
                        <div class="previsualizacion2">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Mortyplicidad</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain3">
                    
                    <a href="IdiomasT5C3.html" >
                        <label>Capitulo 3</label>
                        <div class="previsualizacion3">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Una Mortyandad Conveniente</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain4">
                    
                    <a href="IdiomasT5C4.html" >
                        <label>Capitulo 4</label>
                        <div class="previsualizacion4">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Día de la Rickdependencia</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain5">
                    
                    <a href="IdiomasT5C5.html" >
                        <label>Capitulo 5</label>
                        <div class="previsualizacion5">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Grickfitti Amortycano</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain6">
                    
                    <a href="IdiomasT5C6.html" >
                        <label>Capitulo 6</label>
                        <div class="previsualizacion6">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>El Increíble Día de Explota Acción de Gracias</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain7">
                    
                    <a href="IdiomasT5C7.html" >
                        <label>Capitulo 7</label>
                        <div class="previsualizacion7">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Gotron, Jerrys y Rickvangelion</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain8">
                    
                    <a href="IdiomasT5C8.html" >
                        <label>Capitulo 8</label>
                        <div class="previsualizacion8">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Eterna Amistad de una Mente sin Rickcuerdos</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain9">
                    
                    <a href="IdiomasT5C9.html" >
                        <label>Capitulo 9</label>
                        <div class="previsualizacion9">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>¿Cómo Sobrevivir a Mi Rick?</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain10">
                    
                    <a href="IdiomasT5C10.html" >
                        <label>Capitulo 10</label>
                        <div class="previsualizacion10">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Rickmurai Jack</label>
                        </div>
                    </a>
                </div>
    ...
    <div class="contacto">
        ...
        <?php
    $archivo = "./Contadores de visitas/ContadorTemporada5.txt";
