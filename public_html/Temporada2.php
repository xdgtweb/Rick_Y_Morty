...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./Estilos/Temporada 2.css"/>
    ...
    <body>
        ...
        <main>
            ...
            <div class="main2"><label>Temporada 2</label></div>
            
            <div class="main3">
                <div class="cajamain1">
                    <a href="IdiomasT2C1.html" >
                        <label>Capitulo 1</label>
                        <div class="previsualizacion1">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Rupturas en el Tiempo</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain2">
                    
                    <a href="IdiomasT2C2.html" >
                        <label>Capitulo 2</label>
                        <div class="previsualizacion2">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Morty Escapa de Noche</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain3">
                    
                    <a href="IdiomasT2C3.html" >
                        <label>Capitulo 3</label>
                        <div class="previsualizacion3">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Asimilación Autoerótica</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain4">
                    
                    <a href="IdiomasT2C4.html" >
                        <label>Capitulo 4</label>
                        <div class="previsualizacion4">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Rick, Vengador del Futuro</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain5">
                    
                    <a href="IdiomasT2C5.html" >
                        <label>Capitulo 5</label>
                        <div class="previsualizacion5">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Ponte Ricoso</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain6">
                    
                    <a href="IdiomasT2C6.html" >
                        <label>Capitulo 6</label>
                        <div class="previsualizacion6">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Los Ricks Deben Estar Locos</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain7">
                    
                    <a href="IdiomasT2C7.html" >
                        <label>Capitulo 7</label>
                        <div class="previsualizacion7">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Problemas con Mini-Rick</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain8">
                    
                    <a href="IdiomasT2C8.html" >
                        <label>Capitulo 8</label>
                        <div class="previsualizacion8">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>Televisión Interdimensional 2</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain9">
                    
                    <a href="IdiomasT2C9.html" >
                        <label>Capitulo 9</label>
                        <div class="previsualizacion9">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>El Día de la Purga</label>
                        </div>
                    </a>
                </div>
                <div class="cajamain10">
                    
                    <a href="IdiomasT2C10.html" >
                        <label>Capitulo 10</label>
                        <div class="previsualizacion10">
                            <div class="playlogo"></div>
                        </div>
                        <div class="tituloEpisodio">
                            <label>La Squanch-Boda</label>
                        </div>
                    </a>
                </div>
    ...
    <div class="contacto">
        ...
        <?php
    $archivo = "./Contadores de visitas/ContadorTemporada2.txt";
